...
export const ForgotPassword = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const url = `${BACKEND_URL}/api/v1/user/changePassword`;
    const data = { id: userDetails.id, password: password };
    try {
  ...
  return (
    <>
      {isLoading ? (
        <div className="mt-32 mr-20 text-center">
          <div role="status">
            <svg
              aria-hidden="true"
        ...
        <div className="pt-10 w-[90%]">
          <form onSubmit={handleSubmit}>
            ...
            <div className="pt-2">
              <Button value="Change Password" onClick={handleSubmit} />
            </div>
          </form>
        </div>
      )}
